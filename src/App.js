...
const App = () => {
  const [MovieData, setMovieData] = useState([
    ...
    },
    {
      title: "Out of Death",
      description:
        "Synopsis: From Death Retired Officer Jack Harris returns to the field when he finds a witness to a murder in a remote wilderness, and must protect her from a group of corrupt cops.",
      posterUrl:
        "https://cimalina.com/wp-content/uploads/2021/06/Ashampoo_Snap_2021.06.27_12h30m41s_006_-238x325.png",
      rating: 3,
    },
    {
      title: "Bats",
    ...
    },
    {
      ...
      posterUrl:
        "https://cimalina.com/wp-content/uploads/2021/06/Ashampoo_Snap_2021.06.25_11h34m34s_004_-238x310.png",
      rating: 5,
    },
    {
  ...
  return (
    <>
      <div className="App">
        ...
        />
        {handleShow ? (
          <AddMovie setHandleShow={setHandleShow} addMovie={addMovie} />
        ) : null}
        <div className="filter">
          <Filter MovieData={MovieData} searchTerm={searchTerm} rate={rate} />
        </div>
      </div>
      <footer className="footer">Created By Akrem Wahabi</footer>
    </>
  );
};
